...
const DealRequestStruct = [
  "baga6ea4seaqebz5pn6im24kfm77qrnjb4xk2akxxds4jnoxt6qzo6oxijciammi", // pieceCID 
  2048, // pieceSize (Generated in previous step)
  false, // verifiedDeal (whether the deal has datacap or not)
  "bafybeiecogwbysvpz2vedx3gtlxly2rgetlycvynttyh5e5qit4ywrsvrq", // DataCID (generated in previous step)
  ...
  const extraParamsV1 = [
  "https://data-depot.lighthouse.storage/api/download/download_car?fileId=564cb9b3-9072-4d3b-bb5a-dcf342f39df7.car", // carLink (Generated in previous step)
  1472, // carSize (Generated in previous step).
